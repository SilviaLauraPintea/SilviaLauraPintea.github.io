...
\begin{document}
	...
	\begin{center} 
		...
		\begin{tabular}{ll}
		    ...
		    \begin{tabular}{l}
                   ...
                   \textsc{Webpage:} \href{http://silvialaurapintea.github.io}{http://silvialaurapintea.github.io} \vspace{5px}\\
                    ...
                    My current focus is medical image analysis for cancer detection and segmentation.
		        \end{tabular}\\
            \end{tabular}
		%====================================================================================================
		...
		\begin{tabular}{r@{\hskip 0.3in}p{13.3cm}}
			%NKI_________________________________________________________________________
