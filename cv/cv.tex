...
\begin{document}
	...
	\begin{center} 
		...
		\begin{tabular}{ll}
		    ...
		    \begin{tabular}{l}
                   ...
                   \textsc{Webpage:} \href{http://silvialaurapintea.github.io}{http://silvialaurapintea.github.io} \vspace{5px}\\
                    ...
                    experience with video and image analysis, specifically scale-invariance,\\
                    motion analysis and regression problems.\\

                    Currently my work focuses on efficient and effective video analysis.\\
		        \end{tabular}\\
            \end{tabular}
		%====================================================================================================
		...
		\begin{tabular}{r@{\hskip 0.3in}p{13.3cm}}
			...
			\gray \textsc{\textbf{Senior PostDoc}} & \textsc{\textbf{Division of Image Processing (LKEB), LUMC, NL}}\\
			\textsc{Job Description}              & Focus on efficient analysis of surgery videos.\\
			\textsc{Period}                        & \textsc{May 2022 --- Present} 
            \vspace{5px}\\
			%TUDelft_________________________________________________________________________
			\gray \textsc{\textbf{Assistant Professor (TT)}} & \textsc{\textbf{Vision Lab, Delft University of Technology, Delft, NL}}\\
