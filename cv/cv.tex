...
\begin{document}
	...
	\begin{center} 
        ...
        \begin{tabular}{p{4.5cm}@{\hskip 0.3in}p{11.3cm}}
          ...
          \textsc{Invited speaker}            & Data Science Seminars (Radboud,
          2026), Digital Society Institute Meet Up (Twente, 2026), Startup Village (Amsterdam, 2022), AIRLab (Delft, 2019), NucTech meeting (Delft, 2018), Delft-Leiden Deep Learning Seminars (Leiden, 2019)\\
